  ...
  const SampleNextArrow: React.FC<SampleArrowProps> = ({
    ...
    return (
      <div className={className} style={{ ...style }} onClick={onClick}>
        <div
          className="relative bg-[#0351FC] md:flex items-center justify-center  hidden  w-[30px] rounded-[50%]  h-[30px]"
          onClick={onClick}
        >
          <img
            src={arrowright}
            alt="not found"
            className="w-[20px] mx-auto   h-[20px]"
          />
        </div>
      </div>
    );
  ...
  return (
    <>
      <div className="padding-x ">
        <h2 className="text-3xl text-center mb-12 text-black font-bold">
          <span className="border-b-2 pb-2 border-blue-600">
            Our Top Prime Properties
          </span>
        </h2>
