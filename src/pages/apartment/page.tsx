...
function Apartment() {
  ...
  const [category, setCategory] = useState("One Apartment");
  const [locations, setLocations] = useState("One Location");
                ...
                <>
                  ...
                  <div className="bg-[#FFF] flex gap-5 flex-col p-5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <button className='mt-5 mx-2 border-[1px] border-blue-600 p-2 rounded-[4px] text-lg text-blue-600'> <ChevronLeft /></button>
              ...
              {step === 2 && (
                <>
                  ...
                  <div className="bg-[#FFF] flex gap-5 flex-col p-5">
                    ...
                    <p className="text-[#000000] text-sm font-normal text-center">You're listing:
                    </p>
              ...
              {step === 3 && (
                <>
                  ...
                  <div className="bg-[#FFF] flex gap-5 flex-col p-5">
                    ...
                    <p className="text-[#000000] text-sm font-normal text-justify">If your property is listed on Airbnb, you can speed up registration by importing it directly to Booking.com.
                    </p>
